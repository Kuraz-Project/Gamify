...
import {
  FaUser, FaEnvelope, FaMapMarkerAlt, FaClock,
  FaWallet, FaTrophy, FaUsers, FaCog, FaCamera,
  FaBell, FaMoon, FaSun
} from 'react-icons/fa'
...
const Profile = () => {
  ...
  // ✅ Keep avatar in sync if user changes
  useEffect(() => {
    if (user?.avatar) {
            ...
            <CardContent className="space-y-6">
                    ...
                    {avatarOptions.map((url, idx) => (
                      ...
                      >
                        <Avatar className="h-12 w-12">
                          <AvatarImage src={url} />
                          <AvatarFallback>A{idx + 1}</AvatarFallback>
                        </Avatar>
                      </Button>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onBlur={(e) =>
                        isEditing && updateUser((prev) => ({ ...prev, name: e.target.value }))
                      }
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      onBlur={(e) =>
                        isEditing && updateUser((prev) => ({ ...prev, email: e.target.value }))
                      }
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onBlur={(e) =>
                    isEditing && updateUser((prev) => ({ ...prev, bio: e.target.value }))
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      onBlur={(e) =>
                        isEditing &&
                        updateUser((prev) => ({ ...prev, location: e.target.value }))
                      }
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Select>
                      <SelectTrigger>
                        <SelectValue placeholder={user.timezone || 'UTC+3 (East Africa Time)'} />
                      </SelectTrigger>
                      <SelectContent>
                        {['UTC+3 (East Africa Time)', 'UTC+0 (GMT)', 'UTC-5 (EST)', 'UTC-8 (PST)'].map(
                          (tz) => (
                            <SelectItem
                              key={tz}
                              value={tz}
                              onClick={() =>
                                updateUser((prev) => ({ ...prev, timezone: tz }))
                              }
                            >
                              {tz}
                            </SelectItem>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Receive updates about sessions and activities
                    </p>
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">${user.wallet?.balance}</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
